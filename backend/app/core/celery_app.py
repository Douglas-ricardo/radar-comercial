...
celery_app = Celery(
    ...
    broker=REDIS_URL,
    backend=REDIS_URL,
    include=["app.workers.tasks", "app.workers.notification_tasks", "app.workers.sync_tasks", "app.workers.outreach_tasks", "app.workers.webhook_tasks", "app.workers.campaign_tasks", "app.workers.compliance_tasks", "app.workers.crm_tasks"],
)
